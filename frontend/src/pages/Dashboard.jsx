    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 flex-1 gap-x-8 gap-y-4 md:gap-y-0 h-full">
            ...
            <div className="md:col-span-3 flex flex-col gap-y-5">
                {/* 2fa components */}
                <div className='flex p-3 gap-x-4 items-center bg-gradient-to-tr from-lime-100 to-green-100 justify-between rounded-md border-solid border-[0.2px] border-green-500'>
                    ...
                    <div className=''>
                        <button className=' rounded-full whitespace-nowrap p-2 bg-green-400 text-white hover:opacity-50'>notification</button>
                    </div>
                </div>
